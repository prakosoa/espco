                ...
                <div class="col-md-3">
                    ...
                    <div class="box box-primary">
                        <div class="box-body box-profile">
                            <img class="profile-user-img img-responsive img-circle" src="{{asset(Auth::user()->photo)}}" alt="User profile picture" style="height:100px; weight:100px;">
                ...
                <div class="col-md-9">
                    <div class="nav-tabs-custom">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="settings">
                                <form class="form-horizontal" method="post" action="{{url('user/editpwu/edit')}}" enctype="multipart/form-data">
                                    {{ csrf_field() }}
